...
* `NGX_HTTP_SLA_MAX_COUNTERS_LEN` - максимальное количество счетчиков (апстримов) в пуле (по умолчанию 128).
* `NGX_HTTP_SLA_MAX_POOLS_LEN` - максимальное количество пулов (по умолчанию 128).
* `NGX_HTTP_SLA_MAX_ALIASES_LEN` - максимальное количество алиасов (по умолчанию 128).
